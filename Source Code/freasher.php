...
<div class="navbar-header">
  ...
  <div class="container-fluide  bgcolor">
    <h1><center>Fresher Registeration Form</center></h1>

   <b class="p1"><label for="Name"><b>Name</b></label><br></b>
    <input type="text" placeholder="Enter your full name" name="name1" required><br><br>

   <b  class="p1"> <label for="psw">Email ID</label><br></b>
  ...
  <option value="What is your favourite color ?">What is your favourite color ?</option>
   ...
   <b class="p1"><label for="ans"><b>Your Answer</b></label><br></b>
    ...
    <b  class="p1"><label for="psw-repeat">Create Password</label><br></b>
    <input type="password" placeholder="minimum 6 characters"  name="password1" required><br><br>
    
    <b class="p1"> <label for="mobile number">Mobile Number</label><br></b>
    <input type="number" placeholder="enter your 10 digit mobile number" name="mobile1" required><br><br>
    
    
  <b  class="p1"><label for="Current location">Current Location</label> <br></b>
  ...
  <option>chandigarh</option>
   ...
   <b  class="p1"><label for="Upload Resume">Upload Resume</label><br></b>
    <input type="file" placeholder="upload your resume " required name="picture"><br><br>
    ...
    <div class="clearfix">
     <button type="submit" class="cancelbtn" name="submit">Submit Profile</button>
...
if(isset($_FILES['picture']))
  {
    ...
    //include("config.php");
     ...
     $conn=mysqli_connect("localhost","root","","demo1") or die("conection is not establish");
      ...
      $q="insert into fresher(Name,Email_id,chk_qus,chk_ans,Password,Mobile_no,Current_location,Upload_resume) values('".$name."','".$email."','".$qus."','".$ans."','".$password."',".$mobile.",'".$location."','".$path."');";
      echo $q;
      ...
      if($query==true)
      {
       ...
       // header("location:qus_fresher.php");
        echo "<script>location.replace('qus_fresher.php')</script>";
      }
      else
      {
