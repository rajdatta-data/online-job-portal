<?php
include("config.php");
$a="select Email_id,chk_qus,chk_ans from fresher";
...
<div class="pic">
      <center> <div class="fluid-container p4 ">
        <div class="login"><br><br>
                    <center><img src="myimges/loginimg.png" class="img-circle"></center>
                    <br>
                    <h2> <b>Fresher<br>Forget Password</b></h2><br>
...
if(isset($_POST['submit']))
   {
    ...
    ) 
    {
        if ($newpass==$cnfpass) 
        {
            $qr="update fresher set Password='".$newpass."' where Email_id='".$email."'";
            ...
            else
            {
                echo "<script>alert('Password Change Failed');</script>";
                 header('location:forget_fresher.php');
            }
        }
    }
    }
