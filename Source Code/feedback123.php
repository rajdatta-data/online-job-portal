...
<div class="pic">
      <center> <div class="fluid-container p4 ">
        <div class="login"><br><br>
                    <h2><center><b>FEEDBACK TO OUR SITE</b></center></h2>
                    <br>
                    <div class="input-group">
                         <p><label for="Company Name"><b>Your Email</b></label><br></p>
                        <input type="email" placeholder="Enter your email" name="email" class="input-sm">
                    
                    <br><br><br>
                    
                         <p><label for="Name"><b> Your Comment</b></label><br></p>
                        <textarea placeholder="enter your comment" name="comment" class="input-sm"></textarea> 
...
$q="INSERT INTO feedback(Email_id,Comment)VALUES('".$email."','".$comment."')";
