...
<br>
       <p><label for="Name"><b>What do you like about(job Title)?</b></label><br></p>
     <textarea  name="comment2" placeholder="explain it in 2 lines" rows="4" ></textarea><br>
<br>
    

     
     <p><label for="Name"><b>Do you work well with a team?</b></label><br></p>
      <select  name="comment3">
  <option>YES</option>
  <option>NO</option>
</select><br><br>

<p><label for="Name"><b>What can you do for us that other candidates can't?</b></label><br></p>
     <textarea  name="comment4" placeholder="Skills and traits" rows="4" ></textarea><br>

<br>

    
     <p><label for="Name"><b>Where do you see yourself in 5 years?</b></label><br></p>
     <textarea  name="comment5" placeholder="explain in 1 line where do you see yourself in 5 years." rows="4" ></textarea><br><br>

     <p><label for="Name"><b>Why should company Hires you?</b></label><br></p>
     <textarea  name="comment6" placeholder="your strength  " rows="4" ></textarea><br><br><br>
...
if(isset($_POST['submit']))
    ...
    //include("config.php");
     ...
     $conn=mysqli_connect("localhost","root","","demo1") or die("conection is not establish");
      ...
      $q="insert into qus_fresher(about_yourself,job_title,work_in_team,other_cant,yourself_in_5years,why_hire_you) values('".$comment1."','".$comment2."','".$comment3."','".$comment4."','".$comment5."','".$comment6."');";
      echo $q;
